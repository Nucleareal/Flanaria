...
public class AsyncTask_SetViews_DirectMessage extends AsyncTask<String, Integer, Long> implements ILayoutValue, IAsyncTaskParent
{
	...
	public AsyncTask_SetViews_DirectMessage(ListActivity context)
	{
		_context = context;
	...
	protected void onPreExecute()
	{
		...
		_context.setListAdapter(new Adapter_DirectMessage(_context, R.layout.tweet, new ArrayList<DirectMessage>()));
        ((Adapter_DirectMessage)_context.getListAdapter()).setNotifyOnChange(true);
	...
	protected void onPostExecute(Long result)
	{
		...
		((ImageButton)_ButtonLayout.findViewById(R.id.Buttons_DirectMailButton)).setEnabled(false);
		...
		REST = new OnClickListener()
		{
			public void onClick(View v)
			{
				...
				AsyncTask_LoadNewStatuses_DirectMessage task = new AsyncTask_LoadNewStatuses_DirectMessage((ImageButton)v, _context, statusParent);
		...
		AsyncTask_LoadNewStatuses_DirectMessage task = new AsyncTask_LoadNewStatuses_DirectMessage(_button, _context, this);
